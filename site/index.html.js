  ...
  "project": {
    ...
    <section className="lead">
      ...
      <p>
        ...
        GraphQL 对你的 API 中的数据提供了一套易于理解的完整描述，
        使得客户端能够准确地获得它需要的数据，而且没有任何冗余，
        也让 API 更容易地随着时间推移而演进，还能用于构建强大的开发者工具。</p>
    </section>
    ...
    <section className="point1" id="predictable-results">
      <div className="prose">
        ...
        <p>
          ...
          GraphQL 查询总是返回可预测的结果。使用 GraphQL 的应用可以工作得又快又稳，
          因为控制数据的是应用，而不是服务器。</p>
      </div>
      ...
      <section className="point2" id="single-request">
        <div className="prose">
          ...
          <p>
            ...
            而 GraphQL 可以通过一次请求就获取你应用所需的所有数据。
            这样一来，即使是比较慢的移动网络连接下，使用 GraphQL 的应用也能表现得足够迅速。</p>
        </div>
  ...
  origin: Planet
    ...
    <section className="point4" id="powerful-tools">
      <div className="prose">
        ...
        <p>
          不用离开编辑器就能准确知道你可以从 API 中请求的数据，发送查询之前就能高亮潜在问题，
          高级代码智能提示。利用 API 的类型系统，GraphQL 让你可以更简单地构建如同
  ...
  public async IEnumerable<Task<Character>> GetFriendsAsync() {
    ...
    <section className="powered-by" id="whos-using">
      <div className="prose">
        <h2>谁在使用 GraphQL？</h2>
        <p>
          Facebook 的移动应用从2012年就开始使用 GraphQL。
          一个 GraphQL 规范于2015年开源，现在已经能多种环境下使用，
          并被各种体量的团队所使用。</p>
      </div>
      <div className="logos">
